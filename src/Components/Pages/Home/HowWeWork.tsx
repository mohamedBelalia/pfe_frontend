...
const ExplainerVideo = ({id}:ExplainerVideo) => {
    ...
    switch (id) {
        case 1 : path = "./explaing_imgs/easy.png" ;
            break ;
        case 2 : path = "./explaing_imgs/search.png" ;
            break ;
        case 3 : path = "./explaing_imgs/share.png" ;
            break ;
        default : path = "./explaing_imgs/easy.png" ;
            break ;
    }

    return (
        <div className="w-full h-[400px] border-2 border-[#349292] rounded-md overflow-hidden">
