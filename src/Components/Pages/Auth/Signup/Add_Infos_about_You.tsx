...
const handleImageChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    return (
        ...
        <div className='flex flex-col items-center  '>
            ...
            <div className="md:flex md:justify-center w-[100%]  my-4 md:w-[70%] md:py-4 ">
                ...
                <div className='flex mx-6 flex-col '>
                    ...
                    <textarea value={description} onChange={(e)=>updateFields({description: e.target.value})} required  placeholder='Description' className='border-2 p-3 h-24 md:h-36 rounded-md bg-gray-200' name="description" id="description" cols={50} rows={6} />
                </div>
            </div>
