...
const Add_Infos_about_You = ({ userImage, description, updateFields }: UserFormProps) => {
    ...
    return (
        ...
        <div className='flex  w-full flex-col mt-18 md:mt-4 h-[70vh] items-center  '>
            ...
            <div className={`${!isArabic ? "" : "md:flex-row-reverse"} md:flex w-full md:justify-center  m-auto my-4 md:py-4`}>
                <div className={`${!isArabic ? "" : "flex justify-end"} md:mr-16 mx-6`}>
                    <label htmlFor="image" >
                        ...
                        {userImage != null ? <img onChange={() => handleImageChange} className='object-cover bg-gray-200 border-2  md:w-[200px] md:h-[200px] rounded-lg h-40 w-40' src={URL.createObjectURL(userImage)} /> : <div className="md:w-[200px] md:h-[200px] border mt-2 rounded-xl flex justify-center items-center"><CiImageOn className='text-gray-500  text-[200px] bg-gray-200 border-2 rounded-lg   md:h-40 md:w-40' /></div>}
                    </label>
                </div>
                <div className={`${!isArabic ? "" : "items-end"} flex mx-6 flex-col`} >
                    ...
                    <textarea
                        ...
                        className='border-2 p-3 h-[200px] mt-2 md:w-[450px] md:h-38 sm:w-80 rounded-md bg-gray-200'
                        name="description"
