        ...
        <div className='lg:px-10  py-6 rounded-md px-4 w-full md:ml-10'>
            ...
            <div className='flex items-center justify-center text-teal500'>
                <div className="flex flex-col justify-center items-center">
                    ...
                    {isArabicSelected ? <div className="flex font-semibold flex-row">
            ...
            {/* Your Works */}
            <div className=" ">
                <div className={`flex text-teal500 text-2xl font-semibold pb-2 ${isArabicSelected ? "justify-end" : "justify-start"}`}>
                    <div className={`flex text-[20px] md:text-md lg:text-lg md:text-2xl items-center ${isArabicSelected ? "flex-row-reverse" : ""}`}>
                ...
                <div className={`flex w-full  justify-between items-center flex-wrap ${isArabicSelected ? "flex-row-reverse" : ""}`}>
