...
const Card = () => {
  ...
  return (
            ...
            <div className='p-4 pb-6 mb-3 border text-center  bg-gray-100 rounded-xl'>
                ...
                <img className=' w-36 m-auto mt-6 mb-3 rounded-full ' src="public\imgUsed\portrait-man-laughing.jpg" alt="" />
                <div className="text-teal500 text-xl font-semibold flex justify-center pb-4">
                    <div >Ahmed Akrami </div>
                    <TbStars className="ml-3 text-yellow-500"/>
                </div>
                <div className="text-sm w-72 m-auto text-600 font-semibold text-gray700">I will be happy to help you and do everything quickly and efficiently. I like my job and I like helping people</div>
                <div>
