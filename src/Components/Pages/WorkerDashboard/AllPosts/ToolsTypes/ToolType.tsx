...
const ToolType = ({isEnable}:IPROPS) => {
   
    const [showToolType , setShowToolType] = useState<string>("block");
  ...
  return (
    ...
    <div   
        ...
        <button onClick={()=>{setShowToolType("none")}} className="flex justify-end  text-white">
