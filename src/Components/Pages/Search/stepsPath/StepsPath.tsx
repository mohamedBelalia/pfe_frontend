        ...
        <div className="h-[70px] tab:w-[80%] w-[95%] mx-auto bg-gray-300 rounded-xl px-5 flex gap-8">
            ...
            <div className=" w-full flex justify-center items-center px-4">
                <div className="h-[80%] w-full flex items-center gap-2">
                    ...
                    <div className="w-[25%] rounded-full overflow-hidden relative">
                        <div className="w-full h-[4px] tab:h-[6px] bg-gray-400"></div>
                        <div className="w-[0%] transition-all ease-in-out duration-700 h-[4px] tab:h-[6px] bg-[#349292] absolute top-0 left-0"></div>
                    </div>

                    <div className="-ml-1 w-[15px] h-[15px] md:w-[30px] md:h-[30px] bg-gray-300 text-gray-400 border-2 border-gray-400 rounded-full flex justify-center items-center">
                        <p className="font-bold hidden md:block">4</p>
                    </div>
