    ...
    <div>
        <div>
            ...
            <div className="w-[250px] relative z-50">
              <div onClick={()=>setIsClicked(!isClicked)} className="bg-gray-100 border border-gray-400 rounded-md h-[37px] flex justify-center gap-4 items-center cursor-pointer select-none">
